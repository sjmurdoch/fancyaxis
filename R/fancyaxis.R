...
fancyaxis <- function(side, summ, at=NULL, mingap=0.5, digits=2,
                      shiftfac=0.003, gapfac=0.003, mdotcol='red') {
  # side: like axis()
  ...
  # Draw the mean
  if (!xaxis) {
    points(meanbase, amean, pch=18, cex=0.7, col=mdotcol, xpd=TRUE)
  } else {
    points(amean, meanbase, pch=18, cex=0.7, col=mdotcol, xpd=TRUE)
  }
}
